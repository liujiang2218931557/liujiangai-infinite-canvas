...
- Stable browser build checkpoint: the commit created after the current final audit; it will have passed clean npm install, typecheck, build, and local HTTP smoke.
